...
class HolidayCollection implements \ArrayAccess, \IteratorAggregate, \Countable
{
    ...
    * @param  \Ulpi\Holidays\Holiday $value  The value to set.
    * @throws \Ulpi\Holidays\Exception
    ...
    * - name:        The holyday name. If an language is defined and exists, it have the requested language,
    *                Otherwise it uses the default language
    * - description: An optional holyday description text
    ...
    * @param  string|null $language    The required holyday name language (empty means the default language)
    * @return array
    * @throws \Ulpi\Holidays\Exception
    */
    ...
    *
    * @param  array $regions
    * @return \Ulpi\Holidays\HolidayCollection
    */
    ...
    * @throws \Ulpi\Holidays\Exception
    */
   public function registerGlobalCallback( string $name, $callbackFunction ) : HolidayCollection
   {

      if ( ! \is_callable( $callbackFunction ) )
      {
         throw new Exception( 'Can not define the global callback "' . $name . '" becaus it is not an callable!' );
      }
    ...
    *
    * @param  \Ulpi\Holidays\Holiday $holyday
    * @return \Ulpi\Holidays\HolidayCollection
    */
   public function add( Holiday $holyday ) : HolidayCollection
   {

      $this->records[] = $holyday;
    ...
    *
    * @param  \Ulpi\Holidays\Holiday[] ...$holydays
    * @return \Ulpi\Holidays\HolidayCollection
    */
   public function addRange( Holiday ...$holydays ) : HolidayCollection
   {

      $this->records = \array_merge( $this->records, $holydays );
