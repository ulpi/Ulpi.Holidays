...
return HolidayCollection::Create( 'Deutschland', 'de' )
   ...
   ->addRange(
      ...
      Holiday::Create( HolidayType::DYNAMIC_BASE )
         ...
         ->addNameTranslations(
            'en', 'Easter Sunday',        'fr', 'Dimanche de Pâques',      'it', 'Domenica di Pasqua',
            'es', 'Domingo de Pascua',    'pt', 'Domingo de Páscoa',       'cz', 'Boží hod velikonoční',
            'jp', '復活の主日' )
   ...
   ->addRange(
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->setDay  ( 1, false )
         ->addNameTranslations(
            'en', 'Labor Day',            'fr', 'Fête du travail',         'it', 'Festa dei lavoratori',
            'es', 'Día laboral',          'pt', 'Dia de trabalho',         'cz', 'Svátek práce',
            'jp', '労働者の日' )
         ->addNames(
   ...
   ->addRange(
      ...
      Holiday::Create( HolidayType::DYNAMIC_BASE )
         ...
         ->addNameTranslations(
            'en', 'Whit Sunday',              'fr', 'Whitsunday',              'it', 'Pentecoste',
            'es', 'Domingo de Pentecostés',   'pt', 'Domingo de Pentecostes',  'cz', 'Whitsunday',
            'jp', 'ウィットサンデー' )
   ...
   ->addRange(
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->addNameTranslations(
            'en', 'Augsburg High Peace Festival',        'fr', 'Augsburg Festival de Haute Paix',
            'it', 'Festival High Peace Augsburg',        'es', 'Festival Superior de la Paz de Augsburgo',
            'pt', 'Festival alta Paz Augsburg',          'cz', 'Augsburg Festival High Peace',
   ...
   ->addRange(
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->addNameTranslations(
            'en', 'Day of German unity',        'fr', 'Journée de l\'unité allemande',
            'it', 'Giorno dell\'Unità tedesca', 'es', 'Día de la Unidad Alemana',
            'pt', 'Dia da Unidade Alemã',       'cz', 'Den německé jednoty',
            'jp', 'ドイツ統一の日' )
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->addNameTranslations(
            'en', 'Reformation Day',      'fr', 'Fête de la Réformation',  'it', 'Festa della Riforma',
            'es', 'Dia da Reforma',       'pt', 'Día de la Reforma',       'cz', 'Den reformace',
            'jp', '宗教改革記念日' )
         ->addNames(
