...
class Holiday
{
    ...
    *
    * All usable types are defined as constants of {@see \Ulpi\Holidays\HolidayType}
    *
    * @type string
    */
   protected $type;
    ...
    *
    * - {@see \Ulpi\Holidays\HolidayType::STATIC}
    *   Used as holiday date month part
    * - {@see \Ulpi\Holidays\HolidayType::STATIC_BASE}
   ...
   /**
    * If the type is {@see \Ulpi\Holidays\HolidayType::STATIC_BASE} or
    * {@see \Ulpi\Holidays\HolidayType::DYNAMIC_BASE} the value defined here is the
    ...
    * {@see \Ulpi\Holidays\HolidayType::DYNAMIC} or NULL for all other types.
    *
    ...
    * @return Holiday
    */
   public function setDynamicCallback( $dynamicCallback, bool $clearCache = true ) : Holiday
   {
    ...
    * @return Holiday
    */
   public function setConditionCallback( $conditionalCallback, bool $clearCache = true ) : Holiday
   {
   ...
   public function setNameTranslations( string ...$languageNamePairs ) : Holiday
   {
      ...
      for ( $i = 0, $c = \count( $languageNamePairs ); $i < $c - 1; $i += 2 )
      {
         if ( 2 !== \strlen( $languageNamePairs[ $i ] ) )
         {
            $i--;
            continue;
         }
         $this->nameTranslations[ $languageNamePairs[ $i ] ] = $languageNamePairs[ $i + 1 ];
      }
   ...
   /**
    * Adds all defined languages with the translated holyday names.
    *
    * @param  array $languageNamePairs
    * @return \Ulpi\Holidays\Holiday
    */
   public function addNameTranslationsArray( array $languageNamePairs ) : Holiday
   {
      foreach ( $languageNamePairs as $lang => $name )
      {

         if ( 2 !== \strlen( $lang ) )
         {
            throw new \LogicException(
               'Can not set holiday name translation if the language "' . $lang . '" is invalid!' );
            break;
         }

         $this->nameTranslations[ $lang ] = $name;
    ...
    *
    * @param  \Ulpi\Holidays\HolidayName $name
    * @return Holiday
    */
    ...
    *
    * @param  \Ulpi\Holidays\HolidayName[] ...$names
    * @return Holiday
    */
