...
use Ulpi\Holidays\HolidayCollection;
...
return HolidayCollection::Create( 'United Kingdom', 'en' )
   ...
   ->addRange(
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->addNameTranslations(
            'de', 'Neujahr',              'fr', 'Jour de l\'An',           'it', 'Capodanno',
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->setConditionCallback( function( $year ) { return \Ulpi\Holidays\is_sunday( $year, 1, 1 ); }, false )
         ->addNameTranslations(
            'de', 'Verschobener Feiertag - Neujahr',  'fr', 'Vacances Motion - Jour de l\'An',
            'it', 'Spostato vacanze - Capodanno',     'es', 'Movido vacaciones - Año Nuevo',
            'pt', 'Feriado moveu - Mãe de Deus',      'cz', 'Přesunuta dovolená - Nový rok',
            'jp', '振（り）替（え）休日 - 元日' )
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         // is only valid if 01-01 was on a sunday
         ->setConditionCallback( function( $year ) { return \Ulpi\Holidays\is_saturday( $year, 1, 1 ); }, false )
         ->addNameTranslations(
            'de', 'Verschobener Feiertag - Neujahr',  'fr', 'Vacances Motion - Jour de l\'An',
            'it', 'Spostato vacanze - Capodanno',     'es', 'Movido vacaciones - Año Nuevo',
            'pt', 'Feriado moveu - Mãe de Deus',      'cz', 'Přesunuta dovolená - Nový rok',
      ...
      Holiday::Create( HolidayType::STATIC )
         ->setMonth( 1, false )->setDay( 2, false ) // 01-02
         ->addNameTranslations(
            'de', 'Schottisches Neujahr',          'fr', 'Écossaise Nouvel an',           'it', 'Scottish nuovo anno',
            'es', 'Scottish Año Nuevo',            'pt', 'Scottish Ano Novo',             'cz', 'Scottish Nový rok',
            'jp', 'スコットランドの新年' )
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->setConditionCallback( function( $year ) { return \Ulpi\Holidays\is_sunday( $year, 1, 2 ); }, false )
         ->addNameTranslations(
                'de', 'Verschobener Feiertag - Schottisches Neujahr',  'fr', 'Vacances Motion - Écossaise Nouvel an',
                'it', 'Spostato vacanze - Scottish nuovo anno',        'es', 'Movido vacaciones - Scottish Año Nuevo',
                'pt', 'Feriado moveu - Scottish Ano Novo',             'cz', 'Přesunuta dovolená - Scottish Nový rok',
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->setConditionCallback( function( $year ) { return \Ulpi\Holidays\is_saturday( $year, 1, 2 ); }, false )
         ->addNameTranslations(
            'de', 'Verschobener Feiertag - Schottisches Neujahr',  'fr', 'Vacances Motion - Écossaise Nouvel an',
            'it', 'Spostato vacanze - Scottish nuovo anno',        'es', 'Movido vacaciones - Scottish Año Nuevo',
            'pt', 'Feriado moveu - Scottish Ano Novo',             'cz', 'Přesunuta dovolená - Scottish Nový rok',
   ...
   ->addRange(
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->addNameTranslations(
            'de', 'St. Patrick\'s Day',   'fr', 'Le jour de la Saint-Patrick',  'it', 'Giorno di San Patrizio',
            'es', 'Día de San Patricio',  'pt', 'Dia de São Patrick',           'cz', 'Den svatého Patrika',
            'jp', '聖パトリックの日' )
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->setConditionCallback( function( $year ) { return \Ulpi\Holidays\is_sunday( $year, 3, 17 ); }, false )
         ->addNameTranslations(
            'de', 'Verschobener Feiertag - St. Patrick\'s Day',  'fr', 'Vacances Motion - Le jour de la Saint-Patrick',
            'it', 'Spostato vacanze - Giorno di San Patrizio',   'es', 'Movido vacaciones - Día de San Patricio',
            'pt', 'Feriado moveu - Dia de São Patrick',          'cz', 'Přesunuta dovolená - Den svatého Patrika',
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         // is only valid if 03-17 was on a sunday
         ->setConditionCallback( function( $year ) { return \Ulpi\Holidays\is_saturday( $year, 3, 17 ); }, false )
         ->addNameTranslations(
            'de', 'Verschobener Feiertag - St. Patrick\'s Day',  'fr', 'Vacances Motion - Le jour de la Saint-Patrick',
            'it', 'Spostato vacanze - Giorno di San Patrizio',   'es', 'Movido vacaciones - Día de San Patricio',
            'pt', 'Feriado moveu - Dia de São Patrick',          'cz', 'Přesunuta dovolená - Den svatého Patrika',
   ...
   ->addRange(
      ...
      Holiday::Create( HolidayType::DYNAMIC_BASE )
         ...
         ->addNameTranslations(
            'de', 'Karfreitag',           'fr', 'Vendredi Saint',          'it', 'Venerdì Santo',
   ...
   ->addRange(
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->setDay  ( 9, false )
         ->addNameTranslations(
            'de', 'Tag der Befreiung',    'fr', 'Le jour de la libération','it', 'Giorno della liberazione',
            'es', 'Día de la liberación', 'pt', 'Dia da libertação',       'cz', 'Den osvobození',
            'jp', '独立記念日' )
   ...
   ->addRange(
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->addNameTranslations(
            'de', 'Tynwald Tag',       'fr', 'Jour Tynwald',      'it', 'Tynwald Giorno',
            'es', 'Día tynwald',       'pt', 'Dia Tynwald',       'cz', 'Tynwald den',
            'jp', 'ティンワルド日' )
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->addNameTranslations(
            'de', 'Schlacht am Boyne',       'fr', 'Bataille de la Boyne',   'it', 'Battaglia del Boyne',
            'es', 'Batalla del Boyne',       'pt', 'Batalha de Boyne',       'cz', 'Bitva u Boyne',
            'jp', 'ボインの戦い' )
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->setConditionCallback( function( $year ) { return \Ulpi\Holidays\is_sunday( $year, 7, 12 ); }, false )
         ->addNameTranslations(
            'de', 'Verschobener Feiertag - Schlacht am Boyne', 'fr', 'Vacances Motion - Bataille de la Boyne',
            'it', 'Spostato vacanze - Battaglia del Boyne',    'es', 'Movido vacaciones - Batalla del Boyne',
            'pt', 'Feriado moveu - Batalha de Boyne',          'cz', 'Přesunuta dovolená - Bitva u Boyne',
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->setConditionCallback( function( $year ) { return \Ulpi\Holidays\is_saturday( $year, 7, 12 ); }, false )
         ->addNameTranslations(
            'de', 'Verschobener Feiertag - Schlacht am Boyne', 'fr', 'Vacances Motion - Bataille de la Boyne',
            'it', 'Spostato vacanze - Battaglia del Boyne',    'es', 'Movido vacaciones - Batalla del Boyne',
            'pt', 'Feriado moveu - Batalha de Boyne',          'cz', 'Přesunuta dovolená - Bitva u Boyne',
   ...
   ->addRange(
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->addNameTranslations(
            'de', 'Homecoming Day',             'fr', 'Accueil à venir Jour',    'it', 'Ritorno a casa Day',
            'es', 'Día de regreso a casa',      'pt', 'Dia regresso a casa',     'cz', 'Home přichází den',
            'jp', 'ホームカミングデー' )
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->addNameTranslations(
            'de', '1. Weihnachtsfeiertag',      'fr', 'Noël',                    'it', 'Natale',
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->addNameTranslations(
            'de', '2. Weihnachtstag',  'fr', 'Lendemain de Noël',   'it', 'Santo Stefano',
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->setConditionCallback( function( $year ) { return \Ulpi\Holidays\is_saturday( $year, 12, 26 ); }, false )
         ->addNameTranslations(
            'de', 'Verschobener Feiertag - 2. Weihnachtstag',  'fr', 'Vacances Motion - Lendemain de Noël',
            'it', 'Spostato vacanze - Santo Stefano',          'es', 'Movido vacaciones - Sant Esteve',
            'pt', 'Feriado moveu - 2. Dia de Natal',           'cz', 'Přesunuta dovolená - 2. svátek vánoční',
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->setConditionCallback( function( $year ) { return \Ulpi\Holidays\is_sunday( $year, 12, 25 ); }, false )
         ->addNameTranslations(
            'de', 'Verschobener Feiertag - 1. Weihnachtstag',  'fr', 'Vacances Motion - Noël',
            'it', 'Spostato vacanze - Natale',                 'es', 'Movido vacaciones - Navidad',
            'pt', 'Feriado moveu - Natal do Senhor',           'cz', 'Přesunuta dovolená - 1. svátek vánoční',
      ...
      Holiday::Create( HolidayType::STATIC )
         ...
         ->setConditionCallback( function( $year ) { return \Ulpi\Holidays\is_saturday( $year, 12, 25 ); }, false )
         ->addNameTranslations(
            'de', 'Verschobener Feiertag - 1. Weihnachtstag',  'fr', 'Vacances Motion - Noël',
            'it', 'Spostato vacanze - Natale',                 'es', 'Movido vacaciones - Navidad',
            'pt', 'Feriado moveu - Natal do Senhor',           'cz', 'Přesunuta dovolená - 1. svátek vánoční',
